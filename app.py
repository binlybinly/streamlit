...
UUID = os.environ.get('UUID', '1e79828f-b13b-4a48-a08d-07c25ca3b907')  
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', '')     
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          
NEZHA_KEY = os.environ.get('NEZHA_KEY', '')           
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit0716.dfdrgtftd.eu.org')       
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNTQxNjJiNmQ4OTY1NTVhOWFlY2Y0ZjRkMTEzNTU4OTYiLCJ0IjoiMDA0MTMwM2UtM2JlMC00OTIyLWJjYWItY2QyZDVmYWE4YTY4IiwicyI6IlpEbGxZamN4WVdJdE5tSmhPUzAwWWpjd0xXSXdNelV0TURVMk1HRTVPRFpoT1RJMCJ9')            
